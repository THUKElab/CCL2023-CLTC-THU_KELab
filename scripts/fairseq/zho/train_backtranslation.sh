...
DIR_MODEL_STAGE0=models/fairseq/bart/exps/zho/backtranslation/stage0/${DIR_MODEL}
DIR_MODEL_STAGE1=models/fairseq/bart/exps/zho/backtranslation/stage1/${DIR_MODEL}

DIR_INPUT_STAGE0=models/fairseq/bart/preprocess/zho/backtranslation/news8M
...
bash scripts/fairseq/zho/preprocess.sh  -i ${DIR_INPUT_STAGE0}  -o ${DIR_INPUT_STAGE0}
