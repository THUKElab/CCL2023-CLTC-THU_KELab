...
DIR_MODEL=${DIR_MODEL:-"ccl_pn_bt+ccl_open_filter_denoise_ensemble_s5e5_6-seed${SEED}"}
...
DIR_INPUT_STAGE0=models/seq2edit/preprocess/zho/pattern_noise/news8M+ccl_pn0.1*4+bt6.0*4
DIR_INPUT_STAGE1=models/seq2edit/preprocess/zho/real/ccl_open_filter_stage1_denoise/mediate_ensemble_s5e5_6
...
#    --accumulation_size ${UPDATE_FREQ} \
#    --patience 5 \
#    --train_dataset "${DIR_INPUT_STAGE2}/train.char.label.shuf" \
#    --eval_dataset "${DIR_VALID}/valid.char.label" \
