...
def cli_main(
    ...
    # if getattr(cfg.task, "bart_model_file_from_transformers", None) is not None:
    #     cfg.checkpoint.bart_model_file_from_transformers = cfg.task.bart_model_file_from_transformers
    #     logger.info(f"Load model from transformers: {cfg.task.bart_model_file_from_transformers}")
...
"""
# 英文 Baseline
/data/yejh/nlp/GEC/models/backtranslation/preprocess/bea-train2/bin
    --save-dir exps/temp
    --user-dir /data/yejh/nlp/GEC/models/backtranslation/
    --arch two_stage_bart_large
    --restore-file /data/yejh/nlp/resources/bart.large/model.pt
    --task translation
    --max-tokens 1024
    --optimizer adam
    --layernorm-embedding
...
英文 Transformer CutOff
transformer/preprocess/eng/real/bea_train1/bin
    --save-dir transformer/exps/eng/temp
    --user-dir bart
    --finetune-from-model /data/yejh/nlp/GEC/models/fairseq/transformer/exps/eng/cut_off/bea_train1-both_word0.15_reg1-src_drop0.2/checkpoint_last.pt
...
bart/preprocess/zho/real/mucgec_dev/bin
    ...
    --finetune-from-model bart/exps/zho/real/hsk+lang8-src_drop0.2/checkpoint_best.pt
