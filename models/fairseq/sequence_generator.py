# Reproduce Noising Back Translation in the paper
...
class NoisingSequenceGenerator(SequenceGenerator):
    def _generate(
            self,
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            if max_noise is not None:
                cand_scores += torch.rand(cand_scores.size(),device=cand_scores.device) * max_noise
